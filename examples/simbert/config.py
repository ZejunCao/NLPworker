...
class Config(ConfigBase):
    def __init__(self):
        ...
        self.pretrain_checkpoint = os.path.join(self.project_path, '../pretrain/simbert-base-chinese')
        # self.train_checkpoint = os.path.join(self.project_path, 'checkpoint', '1211-02-36-11', 'epoch-4_accurary-0.3558.bin')
        # self.eval_checkpoint = os.path.join(self.project_path, 'checkpoint', '1217_11_27_36', 'epoch3_spearmanr_0.45258602895962896.bin')
